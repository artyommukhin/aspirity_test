...
/// @nodoc
abstract class _$$_StartedCopyWith<$Res> implements $PostEventCopyWith<$Res> {
...
class _$_Started implements _Started {
  ...
  @override
  String toString() {
    return 'PostEvent.started(id: $id)';
  }
...
class _$_Success implements _Success {
  const _$_Success({required this.post});
...
abstract class _Success implements PostState {
  const factory _Success({required final Post post}) = _$_Success;
